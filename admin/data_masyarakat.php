              ...
              <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- HAPUS -->
                            <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['nik'] ?>">
                            HAPUS
                            </a>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    <form action="edit_data.php" method="POST">
                                        ...
                                        <p>Apakah yakin akan menghapus tanggapan <br> <?php echo $data['nama'] ?></p>
                                </div>
                                <div class="modal-footer">
