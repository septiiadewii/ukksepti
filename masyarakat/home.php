<!-- berisi formulir dan riwayat pengaduan -->
<div class="container">
    <div class="row">
            ...
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                     ...
                     <textarea class="form-control" name="isi_laporan" placeholder="Masukkan Isi Laporan" require></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="card-footer" style="background-color: #87CEFA">
                     <center><Button type="submit" name="kirim" class="btn btn-primary">KIRIM</Button></center>
                    </div>
                </form>
                <?php
